...
Motion::Project::App.setup do |app|
  ...
  app.name = 'Inventory iOS'
  app.identifier = 'com.capturethecastle.inventoryios'
  ...
  app.info_plist["NSPhotoLibraryUsageDescription"] = 'To use your camera to scan QR and Bar codes'
